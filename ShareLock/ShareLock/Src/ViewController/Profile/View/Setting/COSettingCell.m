...
@implementation COSettingCell


- (void)setItem:(COSettingItemModel *)item
{
    _item = item;
    [self updateUI];
...
{
    if (!_indicator) {
        _indicator = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"more_icon"]];
