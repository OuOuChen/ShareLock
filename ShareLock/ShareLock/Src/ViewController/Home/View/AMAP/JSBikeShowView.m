...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.label_address.textColor = [UIColor blackColor];
//        self.label_address.backgroundColor = ZXNRandom;
        ...
        view_line.backgroundColor = kGrayColor;
...
//        distance.backgroundColor = ZXNRandom;
        ...
        distance.textColor = kMainFontColor;
...
//        minutes.backgroundColor = ZXNRandom;
        minutes.text = @"距离起始位置";
        minutes.textColor = kMainFontColor;
        ...
        button.backgroundColor = kMainFontColor;
...
//        availTotal.backgroundColor = ZXNRandom;
        ...
        availTotal.textColor = kMainFontColor;
...
//        emptyTotal.backgroundColor = ZXNRandom;
        ...
        emptyTotal.textColor = kMainFontColor;
