...
#define TipImageViewWidth 60
#define TipImageViewHeight 80

#define LSDefaultTipImage @"animalone"
...
- (void)setupViews {
  ...
  tipLabel.textColor = UIColorFromRGBValue(0XB3B3B3);
  tipLabel.font = kFontSizeThree;
  tipLabel.text = @"这里什么都没有，去看看别的吧~";
  ...
  UIImageView *tipImageView =
      [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"animalone"]];
