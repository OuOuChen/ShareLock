...
#pragma mark - publics
+ (YBPopupMenu *)showAtPoint:(CGPoint)point toView:(UIView *)fatherView titles:(NSArray *)titles icons:(NSArray *)icons menuWidth:(CGFloat)itemWidth delegate:(id<YBPopupMenuDelegate>)delegate
{
    ...
    [popupMenu show:fatherView];
    return popupMenu;
}

+ (YBPopupMenu *)showRelyOnView:(UIView *)view toView:(UIView *)fatherView titles:(NSArray *)titles icons:(NSArray *)icons menuWidth:(CGFloat)itemWidth delegate:(id<YBPopupMenuDelegate>)delegate
{
    CGRect absoluteRect = [view convertRect:view.bounds toView:fatherView];
...
+ (YBPopupMenu *)showAtPoint:(CGPoint)point toView:(UIView *)fatherView titles:(NSArray *)titles icons:(NSArray *)icons menuWidth:(CGFloat)itemWidth otherSettings:(void (^) (YBPopupMenu * popupMenu))otherSetting
{
    YBPopupMenu *popupMenu = [[YBPopupMenu alloc] init];
    popupMenu.point = point;
    popupMenu.titles = titles;
...
+ (YBPopupMenu *)showRelyOnView:(UIView *)view toView:(UIView *)fatherView titles:(NSArray *)titles icons:(NSArray *)icons menuWidth:(CGFloat)itemWidth otherSettings:(void (^) (YBPopupMenu * popupMenu))otherSetting
{
    CGRect absoluteRect = [view convertRect:view.bounds toView:fatherView];
    CGPoint relyPoint = CGPointMake(absoluteRect.origin.x + absoluteRect.size.width / 2, absoluteRect.origin.y + absoluteRect.size.height);
    YBPopupMenu *popupMenu = [[YBPopupMenu alloc] init];
...
- (void)show:(UIView *)fatherView
{
    [fatherView addSubview:_menuBackView];
