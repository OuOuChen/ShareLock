...
@interface COBaseNavigationController ()<UINavigationControllerDelegate>
...
+ (void)setupNavigationBarTheme {
    ...
    // 1.设置导航条的背景
    [appearance setBackgroundImage:[UIImage createImageWithColor:kNavBgColor] forBarMetrics:UIBarMetricsDefault];
