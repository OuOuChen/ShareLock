...
@interface COAnimateViewController ()
...
@implementation COAnimateViewController
...
- (void)closeAnimation {
    ...
    [UIView animateWithDuration:time animations:^{
        ...
        // 隐藏个人中心
        [COProfileRootViewController hide];
    }];
}
...
- (void)btnclick {
    COPushBaseViewController *vc = [[COPushBaseViewController alloc] init];
...
- (void)viewDidLoad {
    ...
    // 添加控制器
    COProfileRootViewController *leftVc = [[COProfileRootViewController alloc] init];
