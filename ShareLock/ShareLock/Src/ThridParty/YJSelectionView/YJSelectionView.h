...
/**
 ...
 @return 选择视图
 */
+ (YJSelectionView *_Nonnull)showWithTitle:(NSString *_Nonnull)title options:(NSArray *_Nonnull)optionsArray singleSelection:(BOOL)selection delegate:(id _Nonnull )delegate inView:(UIView *_Nullable)inview completionHandler:(CompleteSelection _Nonnull)handler;
